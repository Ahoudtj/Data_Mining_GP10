...
# This value shows us that 70.688% of customers have an acceptable Credit Score rating
...
hist(Acceptable$Annual_Income)
median(Acceptable$Annual_Income)

hist(Unacceptable$Annual_Income)
median(Unacceptable$Annual_Income)
